...
# METHODS_TO_TEST[kmeans]="2 400 2500"
# METHODS_TO_TEST[fasterpam]="2 500 2000"
# METHODS_TO_TEST[agnes]="2 500 1500"
METHODS_TO_TEST[kmeans]="2500"
...
for METHOD_NAME in "${!METHODS_TO_TEST[@]}"; do 
    ...
    for K_VAL in ${K_VALUES_STR}; do 
        ...
        CLUSTERS_CSV_PATH="clusters/ML-1M/best_clusters/${CLUSTERING_METHOD}.csv" # Caminho do CSV de clusters

        TRAIN_DIR_CURRENT="results/ML-1M/${METHOD_NAME}_k${K_VAL}_${NOW_RUN}"
